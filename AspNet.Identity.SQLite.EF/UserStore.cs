...
namespace AspNet.Identity.SQLite.EF
{
        ...
        where TRole : IdentityRole
    {
        ...
        public SQLiteIdenitityDbContext Database { get; private set; }
        ...
        /// <summary>
        /// Default constructor that initializes a new SQLiteIdenitityDbContext
        ...
        public UserStore()
        {
			...
			new UserStore<TUser,TRole>(new SQLiteIdenitityDbContext());
        }

        /// <summary>
        /// Constructor that takes a SQLiteIdenitityDbContext as argument 
        /// </summary>
        /// <param name="database"></param>
        public UserStore(SQLiteIdenitityDbContext database)
        {
